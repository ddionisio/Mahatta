...
Q3MAP2 - YDNAR - 2.2.0-b12
http://shaderlab.com/

For bug reports, visit the Quake3World level editing forums.

For help, see Jetscreamer's manual here:
...
When BSPing a map, use the -meta switch for smaller BSPs, and
improved in-game performance.

Read lmt.txt for info on how to do lightmapped terrain.

Go to irc.enterthegame.com #q3map or post questions in the Q3W
forums (the Q3Map thread at the top of the Level Editing section)
for help.

Other things to try:

	-debugportals in BSP phase (emits portal surfaces)
	-light -fast -super 2 -filter (equivalent to -extrawide)

Note: Radiosity is slower in this build because it is "correct."
Older builds of q3map incorrectly derived surface light/color.

The BSP phase may take longer because it's doing more work.

Celshading requires a celshader in the form of an entity key
"_celshader" (try a value of "cel/ink" to test).

*****

MOST COMMON SHADERS THAT ARE NODRAW SHOULD ALSO BE TRANS.

A NOTABLE EXCEPTION TO THIS RULE IS "COMMON/CAULK," WHICH SHOULD
NOT BE TRANS FOR OBVIOUS REASONS.

*****

Certain default shaders that shipped with Quake 3 and RtCW have
missing values that cause maps compiled with them to look
"incorrect" with q3map 2.0. This is because it is MUCH more
stringent about how surface parameters are applied and affect
the world.

VLight is gone. If you try to use it, it will fall back to -light
-fast.
...
Too many to list, will get around to this...
...
Shouts to K, djbob, MrD, AstroCreep, SPoG, RR2DO2, TTimo, shadowspawn,
[AF]Haste, jer, AD5, Laerth, Vexar, Pointy, jetscreamer...



----------------------------------------------------------------

Quake 3 copyright 1999 Id Software: http://www.idsoftware.com

** This is not an Id product **

GtkRadiant: http://zerowing.idsoftware.com
QERadiant: http://www.qeradiant.com
Jetscreamer's Manual: http://shaderlab.com/q3map2/manual/
